...
- family_protection_plan_wins (wins) — as needed; anonymous, when a member completes the Family Protection Plan
- asset_transfer_wins (wins) — as needed; anonymous, when a member completes asset inventory + Schedule B/proof of transfer
