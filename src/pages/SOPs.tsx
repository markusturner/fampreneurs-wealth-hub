      ...
      <div className="min-h-screen bg-background text-foreground">
        <div className="container mx-auto max-w-2xl px-4 py-16 text-center">
          ...
          <p className="text-muted-foreground text-sm">
            Standard Operating Procedures are available for members of <strong>The Trust Vault</strong>, <strong>The Private Estate Accelerator</strong>, and <strong>The Succession Society</strong>.
          </p>
