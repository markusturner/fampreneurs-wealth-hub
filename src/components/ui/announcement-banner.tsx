        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            <Button
              variant="secondary"
              size="sm"
              className="bg-white/20 hover:bg-white/30 text-white border-white/30 h-6 sm:h-8 px-2 sm:px-3 text-[10px] sm:text-xs"
              asChild
            >
              <a
            ...
            <Button
              variant="ghost"
              size="icon"
              className="text-white hover:bg-white/20 h-6 w-6 sm:h-7 sm:w-7 shrink-0"
