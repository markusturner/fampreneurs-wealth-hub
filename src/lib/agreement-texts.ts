// Shared agreement text constants used by ProgramAgreement page and admin PDF download

export const TFV_AGREEMENT = `Program Services Agreement
...
export const TFBA_AGREEMENT = `Program Services Agreement
...
The program will include:
    ...
    1. 3-months of Weekly Group Coaching with The Fampreneurs Elite team of coaches and experts (Q&A Accountability Call)
...
export const TFFM_AGREEMENT = `Program Services Agreement
...
Coaching calls – The schedule of calls below occurs on either a monthly or weekly basis. It is highly recommended upon joining The Fampreneurs' Mentorship to attend as many coaching calls as possible.

"When does my year in the mastermind start?"
It starts on the exact date that you joined The Fampreneurs' Mentorship and lasts for 12 months from that point onwards.
...
export const FBU_AGREEMENT = `Course Access Agreement
