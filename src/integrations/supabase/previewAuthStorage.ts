...
const nativeAuthStorage = {
  async getItem(key: string) {
    ...
    // Preserve an existing login when upgrading from localStorage.
...
export function brokeredPreviewStorage() {
  ...
  // Native WebViews may clear browser storage when the app is backgrounded.
  // Capacitor Preferences persists the Supabase session across app launches.
  if (Capacitor.isNativePlatform()) return nativeAuthStorage;
